            ...
            <div className="col-lg-5">
              <div className="tit">
                ...
                <p className="wow fadeInUp" data-wow-delay=".3s">
                  Reprehenderit pariatur eiusmod do aute ipsum velit aliqua eiusmod quis velit id.Labore commodo duis adipisicing enim dolore id tempor labore dolor officia nulla dolore do occaecat. Voluptate irure deserunt fugiat occaecat aute nulla eiusmod ad. Occaecat deserunt non veniam commodo Lorem esse et consectetur incididunt.
                </p>
                {this.renderArrows()}
              </div>
            </div>
